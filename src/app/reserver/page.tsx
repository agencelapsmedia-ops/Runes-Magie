...
export const metadata: Metadata = {
  ...
  description:
    'Reservez votre seance mystique en ligne. Tirage de runes, soins energetiques, consultations spirituelles avec Noctura Anna.',
};
    ...
    <section className="py-16 md:py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-4">
          <span className="text-5xl text-or-ancien animate-glow-pulse select-none block mb-4">
            &#10022;
          </span>
        ...
        <RuneDivider className="my-10" symbols="&#5765; &#10022; &#5765;" />
