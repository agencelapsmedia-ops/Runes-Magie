...
// L'annulation envoie les courriels d'annulation étalés à 600 ms par destinataire
// pour respecter le débit autorisé par Resend. Pour 15 inscrits, cela fait ~9 secondes.
